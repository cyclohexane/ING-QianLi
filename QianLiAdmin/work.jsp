    ...
    <div class="layui-layout layui-layout-admin">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd class="layui-this"><a href="work.jsp">作品管理</a></dd>
                        </dl>
                    </li>
                </ul>
            </div>
        ...
        <div class="page-content">
            <div class="layui-row" style="margin-bottom:10px;">
                <!--这里href链接到前台上传作品的页面，这个页面还没写但是到时候可以套用上传资源的页面-->
                <a class="layui-btn">上传作品</a>
            </div>
            <div class="layui-row">
                <form class="layui-form layui-col-md12 we-search">
                    ...
                    <div class="layui-inline">
                        <input type="text" name="pid" placeholder="请输入作品ID" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-inline">
                        <input type="text" name="pname" placeholder="请输入作品名" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-inline">
            ...
            <table class="layui-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><img class="list-preview" src="test"></td>
