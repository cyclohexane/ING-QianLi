                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd class="layui-this"><a href="announcement.jsp">公告管理</a></dd>
            ...
            <div class="layui-row">
                <form class="layui-form layui-col-md12 we-search">
                    ...
                    <div class="layui-inline">
                        <input type="text" name="ppid" placeholder="请输入公告ID" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-inline">
            ...
            <table class="layui-table">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>千里IT千里IT千里IT</td>
                        <td>千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT千里IT</td>
