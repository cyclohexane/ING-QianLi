                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    ...
                    <li class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd class="layui-this"><a href="source.jsp">资源管理</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item layui-nav-itemed">
            ...
            <div class="page-content">
                ...
                <div class="layui-row">
                    <form class="layui-form layui-col-md12 we-search">
                        ...
                        <div class="layui-inline">
                            <input type="text" name="pid" placeholder="请输入资源ID" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline">
                            <input type="text" name="pname" placeholder="请输入资源名" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline">
